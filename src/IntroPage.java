...
public class IntroPage extends JFrame {
	...
	public void creatButton() {
		...
		howBtn.setFont(new Font("標楷體", Font.PLAIN, 20));
		...
		start.setFont(new Font("標楷體", Font.BOLD, 24));
		...
		start.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				if (rbtLove.isSelected()) {
					...
					JOptionPane.showMessageDialog(panel, "請選擇類別", "Error", JOptionPane.ERROR_MESSAGE);
		...
		comment.setFont(new Font("標楷體", Font.PLAIN, 20));
	...
	public void creatRButton() {
		...
		rbtLove.setFont(new Font("標楷體", Font.PLAIN, 24));
		rbtLove.setBounds(177, 414, 75, 31);
		
		rbtWork.setFont(new Font("標楷體", Font.PLAIN, 24));
	...
	public void creatLayout() {
		...
		avgtxtLabel.setFont(new Font("標楷體", Font.PLAIN, 20));
		avgtxtLabel.setBounds(692, 200, 200, 60);
		
		avgLabel.setBackground(new Color(245, 222, 179));
		avgLabel.setFont(new Font("標楷體", Font.BOLD, 32));
		...
		titleLabel.setFont(new Font("標楷體", Font.BOLD, 48));
		...
		textPane.setFont(new Font("標楷體", Font.BOLD, 24));
